 ...
 *   2. Persistent: ON CONFLICT ON CONSTRAINT notifications_user_dedupe_key_uidx
 *      DO NOTHING silently no-ops a duplicate insert across process restarts.
 *
...
async function writeNotification({ db, userId, summary }) {
  ...
  const result = await db.query(
    `INSERT INTO notifications
     ...
     ON CONFLICT ON CONSTRAINT notifications_user_dedupe_key_uidx DO NOTHING
